...
// Location Search Input action types
export const SAVE_PLACES_API_USAGE = "SAVE_PLACES_API_USAGE";
export const SAVE_GEOCODING_API_USAGE = "SAVE_GEOCODING_API_USAGE";
