...
export function* authUserSaga(action) {
    ...
    try {
        axios.defaults.headers.post['Access-Control-Allow-Origin'] = 'http://18.140.44.44/';
        axios.defaults.headers.post['Origin'] = 'http://18.140.44.44/';
        axios.defaults.headers.post['Referer'] = 'http://18.140.44.44/';
